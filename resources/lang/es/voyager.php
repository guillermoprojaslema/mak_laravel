...
return [
    ...
    'dimmer' => [
        ...
        'barrio_link_text' => 'Ver todos los barrios',
        'barrio_text' => 'Tiene :count :string en su base de datos. Haga clic en el botón de abajo para ver todas los barrios. ',
        ...
        'cliente_link_text' => 'Ver todos los clientes',
        'cliente_text' => 'Tiene :count :string en su base de datos. Haga clic en el botón de abajo para ver todos los clientes. ',

        'conserje' => 'Conserje|Conserjes',
        'conserje_link_text' => 'Ver todos los conserjes',
        'conserje_text' => 'Tiene :count :string en su base de datos. Haga clic en el botón de abajo para ver todos los conserjes. ',
        ...
        'local_comercial' => 'Local Comercial|Locales Comerciales',
        'local_comercial_link_text' => 'Ver todos los locales comerciales',
        'local_comercial_text' => 'Tiene :count :string disponibles en su base de datos. Haga clic en el botón de abajo para ver todos los locales comerciales. ',

        'propietario' => 'Propietario|Propiertarios',
        'propietario_link_text' => 'Ver todos los propietarios',
